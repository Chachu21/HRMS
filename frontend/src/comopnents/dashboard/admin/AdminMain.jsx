...
const AdminMain = () => {
  return (
    <>
      <div className="p-2 lg:ml-[18%] mt-16">
        <div className="border-gray-200 border-solid rounded-md dark:border-gray-300 mt-5 ">
          <div className="grid lg:grid-cols-3 md:grid-cols-2 px-20 gap-5 mb-4">
            <AdminCard request="Employee Approve Request" amount="10" color="bg-blue-500" />
            <AdminCard request="Employee Approve Request" amount="10" color="bg-blue-500" />
            <AdminCard request="Employee Approve Request" amount="10" color="bg-blue-500" />
