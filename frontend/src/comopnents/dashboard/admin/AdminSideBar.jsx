...
const AdminSidebar = () => {
  ...
  return (
    ...
    >
      <aside
        id="logo-sidebar"
        className="fixed top-0 left-0 z-45 lg:w-[18%] w-[25%] h-screen pt-20  text-black bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-white dark:border-gray-200"
        aria-label="Sidebar"
      >
