...
const EmployeeSideBar = () => {
  ...
  return (
    ...
    >
      <aside
        id="logo-sidebar"
        className=" fixed top-16  left-0 z-50 lg:w-[25%] sm:w-[25%]  h-screen pt-20   text-black bg-white border-r border-gray-200 sm:translate-x-3  dark:bg-white dark:border-gray-200"
        aria-label="Sidebar"
      >
