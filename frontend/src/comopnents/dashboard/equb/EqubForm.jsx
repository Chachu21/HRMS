  ...
  return (
    <div className="flex justify-center flex-col pt-20 gap-5 items-center h-[100vh] bg-gray-100 text-gray-700">
      ...
      <p className="text-gray-800 text-xl">
        please create {equbType} equb by fill the following form
      </p>
      <div className="flex">
        <form
          action=""
        ...
        >
          ...
          <button type="submit" className="w-[130px] rounded-lg flex justify-end items-end p-2  text-white bg-blue-400 my-10">
            Create Account
          </button>
        </form>
      </div>
